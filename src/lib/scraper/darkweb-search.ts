...
//
// Inspired by Robin's search.py: queries multiple .onion search engines
...
// Dark-web search engines (Robin uses 16; we support the most reliable ones).
...
// Robin uses ThreadPoolExecutor(max_workers=5); we use Promise.all with
