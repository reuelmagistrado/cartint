...
//   - Rotating User-Agents (9 browser UAs, like Robin)
...
// 9 rotating User-Agents (from Robin's scraper.py)
const USER_AGENTS = [
...
// Retry config (Robin: 3 retries, backoff 0.5, retry on 500/502/503/504)
const MAX_RETRIES = 3;
