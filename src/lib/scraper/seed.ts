...
const SEED: SeedThreat[] = [
  ...
  // --- NVD CVEs (automotive) ---
  {
    externalId: "seed:cve-uds-1",
    title: "CVE-2024-21XX — UDS authentication bypass in infotainment ECU",
    description: "UDS (Unified Diagnostic Services) authentication bypass in a widely-deployed infotainment ECU allows unauthenticated diagnostic commands, enabling firmware read/write.",
    sourceName: "nvd-cve",
    sourceType: "cve",
    ...
    atmTactic: "Telematics Exploitation",
    atmTechnique: "CAN Bus Injection",
    classificationReason: "UDS auth bypass in infotainment ECU — direct vehicle ECU exploitation.",
    dataTypes: "vulnerability",
    verified: true,
  },
  {
    externalId: "seed:cve-tbox-1",
    title: "CVE-2024-22XX — TCU remote command injection via SMS gateway",
    description: "Remote command injection in a telematics control unit's SMS gateway allows remote engine start and location tracking without user interaction.",
    sourceName: "nvd-cve",
    sourceType: "cve",
    sourceUrl: "https://nvd.nist.gov",
    attackDate: days(25),
    ...
    isAutomotive: true,
    relevanceScore: 94,
    automotiveCategory: "Telematics",
    atmTactic: "Telematics Exploitation",
    atmTechnique: "Telematics Unit Takeover",
    classificationReason: "Remote command injection in TCU via SMS — direct telematics takeover.",
    dataTypes: "vulnerability",
    verified: true,
  },
  {
    externalId: "seed:cve-charge-1",
    title: "CVE-2024-23XX — EV charger CSMS protocol auth flaw",
    description: "Authentication flaw in OCPP/CSMS protocol implementation allows a malicious station to impersonate legitimate chargers and manipulate billing.",
    sourceName: "nvd-cve",
    sourceType: "cve",
    sourceUrl: "https://nvd.nist.gov",
    attackDate: days(30),
    ...
    atmTactic: "Telematics Exploitation",
    atmTechnique: "Charging Network Abuse",
    classificationReason: "EV charging CSMS/OCPP auth flaw — charging-infrastructure impact.",
    dataTypes: "vulnerability",
    verified: true,
  },
