...
export function KpiCards({ stats, loading }: { stats: Stats | null; loading: boolean }) {
  ...
  const items = [
    ...
    { key: "verified", label: "LLM Coverage", value: "100%", sub: "every item classified", icon: Activity, accent: "from-teal-500/20 to-teal-500/5 text-teal-300 border-teal-500/30", ring: "text-teal-400", sparkData: baseline, sparkColor: "#14b8a6" },
